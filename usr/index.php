...
<body>
    ...
    <main>
        <div class="mpgtitl">Enter Customers To Check Drug Use</div>
        <br><br><br>

        <div class="contfm">
            <input type="search" name="" id="" placeholder="Enter Customers To Check Drug Use">
            <div class="cent">
        ...
        <div class="result">
            ...
            <div class="rightres">
                <ul>
                    <li>Names: <b>Munyendiza Kalisa</b></li>
                    <li>Age: <b>29</b></li>
                    <li>Sex: <b>Male</b></li>
                    <li>Residence: <b>Karuruma Kigali Rweso</b></li>
                    <li>Drugs: <b>Allowed</b></li>
                    <li>Records: <b><a href="./records.html">27</a></b></li>
                </ul>
                <a href="./records.html" class="cent"><button>See Records</button></a>
            </div>
        </div>
        <br><br><br><br><br>
