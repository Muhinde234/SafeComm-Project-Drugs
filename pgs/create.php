...
<body>
    ...
    <main>
        <div class="contct" style="width: 90%; margin: 0 auto;">
            <div class="mpgtitl">Create Account</div>
            <div class="contcontainer">
                ...
                <div class="smltxt">If you  have an account <a href="./login.html">Login Here</a></div>
            </div>
        </div>
    </main>
