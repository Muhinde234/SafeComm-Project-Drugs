            ...
            <div class="fboxes">
                ...
                <div class="fbox fbox-2">
                    ...
                    <ul class="ftlinks">
                        ...
                        <li><a href="./guide.html">Guide To Use</a></li>
                        <li><a href="./parenting.html">Parenting Control</a></li>
                        <li><a href="./apply.html">Apply As A Store</a></li>
                        <li><a href="./apply.html">Rules &and; Privacy</a></li>
                    </ul>
                </div>
