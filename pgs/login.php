...
<body>
    ...
    <main>
        <div class="contct" style="width: 70%; margin: 0 auto;">
            <div class="mpgtitl">Log In</div>
            <div class="contcontainer">
                <form action="">
                    ...
                    <div class="cent"><input type="submit" value="LogIn"></div>
                </form>
                <div class="smltxt">If you don't have an account <a href="./create.html">create one here</a></div>
            </div>
        </div>
    </main>
